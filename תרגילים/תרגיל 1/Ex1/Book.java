...
class Book
{
    ...
    {
        int litValue = comicValue + dramaticValue + educationalValue;
        return litValue;
    }
    ...
    {
        //check if someone is already reading this book
        if(currentBorrowerId == NOT_BORROWED)
        {
    ...
    void returnBook()
    {
        currentBorrowerId = NOT_BORROWED;
    }
