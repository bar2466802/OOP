...
public abstract class BasicStorage
{
	 ...
	 */
	public void setOccupiedSpace(int size)
	{
		occupiedSpace = size;
	}
	 ...
	 */
	public double getItemOccupiedPercentage(Item item, int n)
	{
	 ...
	 */
	public double calcItemOccupiedPercentage(Item item, int n)
	{
		double percentage = INITIAL_SIZE;
	 ...
	 */
	public boolean checkIfThereEnoughRoom(Item item, int n)
	{
