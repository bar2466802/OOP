...
public class ProcessOperationFactory
{
			   ...
			   NumberFormatException
	{
		...
		case EXECUTABLE:
			...
			processOperations.get(index).setMetaFilterFlag(bool.equals(FilterCommand.Constants.BOOLEAN_YES));
		}
	}
	/**
	 * Check BTW filter values are valid
	 * @param sizeFilters the array with the given values.
	 * @throws MissingFormatArgumentException if the values are not valid
	 */
