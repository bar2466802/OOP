...
CollectionFacadeSet.java - implements SimpleSet. Wrap an object implementing java’s Collection
interface, such as LinkedList, TreeSet, or HashSet.
...
a wrapper class that has a LinkedList and delegates methods to it.
